    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                ...
                new Product() { ProductId = 6, CategoryId = 1, ImageUrl = "/images/6.jpg", ProductName = "History", Price = 125, ShowCase = false },
                new Product() { ProductId = 7, CategoryId = 1, ImageUrl = "/images/7.jpg", ProductName = "Hamlet", Price = 145, ShowCase = false },
                new Product() { ProductId = 8, CategoryId = 1, ImageUrl = "/images/8.jpg", ProductName = "A Doll's House", Price = 145, ShowCase = true },
                new Product() { ProductId = 9, CategoryId = 1, ImageUrl = "/images/9.jpg", ProductName = "Blindness", Price = 445, ShowCase = true },
                ...
                new Product() { ProductId = 12, CategoryId = 1, ImageUrl = "/images/12.jpg", ProductName = "The Sound of the Mountain", Price = 345, ShowCase = true },
                ...
                new Product() { ProductId = 15, CategoryId = 1, ImageUrl = "/images/15.jpg", ProductName = "Masnavi", Price = 199, ShowCase = true },
